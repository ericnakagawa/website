...
##### `yarn team add <scope:team> <kullanıcı>` [](#toc-yarn-team-add){#toc-yarn-team-add.toc}

Add a user to an existing team.

##### `yarn team rm <scope:team> <kullanıcı>` [](#toc-yarn-team-rm){#toc-yarn-team-rm.toc}
...
### Ayrıntılar [](#toc-details){#toc-details.toc}
